...
const AdditionalInfo = () => {
    ...
    useEffect(() => {
        ...
        console.log("facebook token is", tokenQuery);
    ...
    }, [router.isReady, router.query.token]); // Ensure useEffect runs when router is ready and token changes
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // }
            api.auth.facebook_register({ body: dataToSend })
        }
