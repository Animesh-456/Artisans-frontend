                            ...
                            <div className="inner testimonial_w">
                                <div className="testimonial-card">
                                    <div className="testimonial-content">
                                        ...
                                        <p className="testimonial-feedback"> I am thrilled with the professionalism iOS app developed by [Your Name]. Their professionalism, dedication, and ability to bring our professionalism vision to life were exceptional. The app's user-friendly interface and seamless developer functionality are a testament to their expertise. professionalismA truly talented developer &amp; results. </p>
                                    </div>
                                    <div className="testimonial-meta d-flex align-items-center justify-content-between">
                                        <div className="d-flex gap-3 align-items-center">
                                            <div>
                                                <img src="https://workzone.mamunuiux.com/uploads/custom-images/niloy-mazumdar-20240710125510.png" className="testimonial-author-img" alt="" />
                                            </div>
                                            <div>
                                                <h4 className="testimonial-author-name fw-semibold"> Niloy Mazumdar </h4>
                                                <p className="testimonial-author-title">Founder</p>
                                            </div>
                                        </div>
                                        <div>
